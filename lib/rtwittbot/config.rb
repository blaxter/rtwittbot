module RTwittBot
    module Config
        ...
        # right now, twitter has a limit of 100 request/hour
        # so 1 request per second is fine, i think...
        SLEEP_TIME_IN_SEC = 60 
        # if you wanna receive also your own twits
        RECEIVE_OWN_TWITS = false
        # The data for the jabber bot, you can give one account in a lot of places, for example
        # with every gmail account you can use it for jabber
